...
describe('Teste de api na rota POST de usuarios', () => {
    ...
    it('Não deve cadastrar usuario com email já cadastrado', () => {
        let usuario = usuarios.usuarioData()
    ...
    it('Não deve cadastrar usuario com o campo nome vazio', () => {
        let usuario = usuarios.usuarioData()
        let nomeVazio = ""
    ...
    it('Não deve cadastrar usuario com o campo email vazio', () => {
        let usuario = usuarios.usuarioData()
        let emailVazio = ""
    ...
    it('Não deve cadastrar usuario com o campo password vazio', () => {
        let usuario = usuarios.usuarioData()
        let pdwVazio = ""
    ...
    it('Não deve cadastrar usuario com o campo administrador vazio', () => {
        let usuario = usuarios.usuarioData()
        let admVazio = ""
    ...
    it('Não deve cadastrar usuario com email invalido', () => {
        let usuario = usuarios.usuarioData()
    ...
    it('Não deve cadastrar usuario com o campo nome diferente de string', () => {
        let usuario = usuarios.usuarioData()
        let nomeNull = null
    ...
    it('Não deve cadastrar usuario com o campo email diferente de string', () => {
        let usuario = usuarios.usuarioData()
        let emailNull = null
    ...
    it('Não deve cadastrar usuario com o campo administrador diferente de string', () => {
        let usuario = usuarios.usuarioData()
        let admNull = null
    ...
    it('Não deve cadastrar usuario sem o campo nome', () => {
    ...
    it('Não deve cadastrar usuario sem o campo email', () => {
    ...
    it('Não deve cadastrar usuario sem o campo password', () => {
    ...
    it('Não deve cadastrar usuario sem o campo administrador', () => {
